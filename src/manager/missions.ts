...
export const MISSIONS: Mission[] = [
  ...
  },
  {
    id: "11",
    title: "Blackout",
    briefing: "Dark maze. sense() sees 2 tiles far. Find all 3 crystals.",
    difficulty: "medium",
    tags: ["loops", "memory", "maze"],
    grid: [
      "R...#...",
      ".##.#.#.",
      "..*#...*",
    ...
    energy: 60,
    allowed: ["seq", "vars", "cond", "loops", "funcs", "arrays"],
    starter: "// sense() sees 2 tiles far\n// find all 3 crystals\n",
    need: { collect: 3 },
    hint: "Remember visited tiles in an object. Explore the nearest unknown first.",
    maxSteps: 100,
    viewRadius: 2,
  },
];
